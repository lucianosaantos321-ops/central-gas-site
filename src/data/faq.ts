...
export const faqItems: FAQItem[] = [
  {
    ...
    answer:
      "O link oficial da Play Store ficará disponível nesta página assim que a versão pública estiver liberada.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "A primeira versão trabalha com pagamento conforme informado no app, sem prometer pagamento online quando ele ainda não estiver ativo.",
  },
  {
