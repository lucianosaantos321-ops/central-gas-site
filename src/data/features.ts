...
export const appFeatures = [
  ...
  { title: "Cupons", description: "Base preparada para promoções, primeira compra e campanhas futuras.", icon: Gift },
...
export const howItWorksSteps = [
  { title: "Baixe o app", description: "Instale o Central Gás no Android quando o link da Play Store estiver disponível.", icon: Smartphone },
...
export const partnerFeatures = [
  ...
  "Prepare operação com painel administrativo",
];
